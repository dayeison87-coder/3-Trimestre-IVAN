let yeison_moreno1 = prompt("Ingrese primer valor:");
let yeison_moreno2 = prompt("Ingrese segundo valor:");

let n1 = parseInt(yeison_moreno1, 10);
let n2 = parseInt(yeison_moreno2, 10);
